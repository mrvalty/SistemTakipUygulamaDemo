...
{
    public class PasifUrunRaporController : Controller
    {
        private readonly ProjectContext _context;

        public PasifUrunRaporController(ProjectContext context)
        {
            _context = context;
        }

        public IActionResult PasifUrunRaporAlani(UygulamaKullanici kullanici, int id)
        {
            ...
            return View("PasifUrunRaporAlani", "_Layout");
        }
    }
}
